...
const GROUP_BY_DEF_ARR= (language) => [
    ...
    {
        groupByField:'presence',
        headerFields:['presence'], 
        headerProps:{
            open:{
                padding:10,
                width:'100vw', 
...
const VIEW_FIELDS=['firstName', 'lastName', 'email', 'presence', 'present'];
const VIEW_FIELDS_EXPAND=['firstName', 'lastName', 'email', 'presence', 'present'];
